...
$.post(URL+"index.php/main/loadStudentUserByUserTypeOptions",{accountTypeId:accountTypeId}).done(function(data){
...
<div class='col-sm-8'><select class='form-control' onchange='SYS_setUserByUserType()' id='accountTypeId' ><?= $this->load->view("optiontags/student_usertype_options"); ?></select></div>
</div>
<?php
