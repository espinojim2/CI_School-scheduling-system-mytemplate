...
<button class='btn btn-primary' style='background:rgb(102,0,102);' onclick='SYS_addUserAccount()'><span class='glyphicon glyphicon-plus'></span> Add User Account</button></div>
...
$.post(URL+"index.php/main/loadStudentUserAccountList").done(function(data){ 
...
$.post(URL+"index.php/main/loadStudentAddUserAccountForm",{mode:"add",accountId:""}).done(function(data){
$('#dialog1').html(data);
...
$.post(URL+"index.php/main/loadStudentAddUserAccountForm",{mode:"edit",accountId:accountId}).done(function(data){ 
$('#dialog1').html(data);
$("#wrapper").toggleClass("toggled"); 
$('#dialog1').jseDialog('open');
